...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, colback=white, bottomrule=.15mm, toprule=.15mm, arc=.35mm, opacitybacktitle=0.6, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Workshop Goal}, breakable, opacityback=0, left=2mm, rightrule=.15mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black]
...
\includegraphics[width=7.85in,height=0.72in]{modeling_files/figure-latex/mermaid-figure-1.png}
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, titlerule=0mm, colback=white, bottomrule=.15mm, toprule=.15mm, arc=.35mm, opacitybacktitle=0.6, bottomtitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, breakable, opacityback=0, left=2mm, rightrule=.15mm, toptitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, colback=white, bottomrule=.15mm, toprule=.15mm, arc=.35mm, opacitybacktitle=0.6, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, breakable, opacityback=0, left=2mm, rightrule=.15mm, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black]
